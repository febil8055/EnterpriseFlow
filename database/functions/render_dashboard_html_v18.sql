-- ============================================================
-- EnterpriseFlow - Dashboard renderer, v18
--
...
.hero{position:relative;overflow:hidden;
  ...
  color:var(--ink);
  background:
    radial-gradient(820px 380px at 88% -25%, rgba(41,151,255,.16), transparent 62%),
    linear-gradient(158deg, #1a2130 0%, #10151e 52%, #0b0f16 100%);
  border:1px solid rgba(255,255,255,.09);border-radius:26px;
  box-shadow:0 26px 64px -26px rgba(8,12,20,.60), inset 0 1px 0 rgba(255,255,255,.10);
