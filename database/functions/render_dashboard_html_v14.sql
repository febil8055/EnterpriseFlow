-- ============================================================
-- EnterpriseFlow - Dashboard renderer, v14
--
  ...
  BEGIN
    ...
    IF NOT l_fresh THEN
      ...
      l_prompt :=
        ...
        ||'Match this shape and length exactly:'||CHR(10)
        ||'"Penetration test sign-off is 6 days overdue and is holding up Patient Portal.'
        ||' The other 13 active projects are tracking normally."';
